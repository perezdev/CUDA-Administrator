...
Namespace ColorTables
    ...
    Public MustInherit Class Vs2010CommonColorTable_TC
    ...
    ''' </summary>
    ''' <remarks>Inherit this class, override all properties and return your desired colors.</remarks>
    Public MustInherit Class Vs2010MenuStripColorTable_TC
    ...
    Public MustInherit Class Vs2010ToolStripColorTable_TC
    ...
    Public MustInherit Class Vs2010ControlsColorTable
        ...
        Public MustOverride ReadOnly Property ComboboxBackground As Color
        Public MustOverride ReadOnly Property ComboboxBorder As Color
        Public MustOverride ReadOnly Property DropdownGradientTop As Color
        Public MustOverride ReadOnly Property DropdownGradientBottom As Color
        Public MustOverride ReadOnly Property ButtonHoverTop As Color
        Public MustOverride ReadOnly Property DarkBackground As Color
        Public MustOverride ReadOnly Property ButtonNormalGradientTop As Color
        Public MustOverride ReadOnly Property ButtonNormalGradientMiddle As Color
        Public MustOverride ReadOnly Property ButtonNormalGradientBottom As Color
        Public MustOverride ReadOnly Property ButtonNormalBorder As Color
        Public MustOverride ReadOnly Property StatusStripBackColor As Color
    ...
    Public MustInherit Class Vs2010TabControlColorTable
        ...
        Public MustOverride ReadOnly Property CommonColorTable As Vs2010CommonColorTable
        Public MustOverride ReadOnly Property Background As Color
        Public MustOverride ReadOnly Property BackgroundDotsLight As Color
        Public MustOverride ReadOnly Property BackgroundDotsDark As Color
        ...
        Public MustOverride ReadOnly Property InactiveColor As Color
        Public MustOverride ReadOnly Property Border As Color
        Public MustOverride ReadOnly Property CloseButtonBorder As Color
        Public MustOverride ReadOnly Property CloseButtonHoverBackColor As Color
        Public MustOverride ReadOnly Property CloseButtonClickedBackColor As Color
